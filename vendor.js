// Console shim for <=IE8 without Developer Tools
...
// IE7 polyfill querySelectorAll
if (!document.querySelectorAll) {
  document.querySelectorAll = function(selector) {
    var doc = document,
      head  = document.getElementsByTagName('head')[0],
      style = doc.createElement('style'),
      text  = selector + '{x:expression(document.__qsaels.push(this))}';
...
function makeArray( obj ) {
  ...
  function ImagesLoaded( elem, options, onAlways ) {
    ...
    if ( typeof elem !== 'string' ) {
      throw 'ImagesLoaded elem parameter must be a selector string';
    }
  ...
  ImagesLoaded.prototype.getImages = function() {
    ...
    for ( var i=0, len = this.elements.length; i < len; i++ ) {
      ...
      var childElems = document.querySelectorAll(this.elemSelector + ' img');
...
//       if (x < 0) {
//         $.each($(e.target).parents(), function (i, el) {
//           if ($(el).scrollLeft() > 0) {
//             prevent_left = el;
//             return false;
//           }
...
//       if (true || prevent_left || prevent_up) {
//         e.preventDefault();
//         console.log('Back scrolling prevented');
//       }
//     });
